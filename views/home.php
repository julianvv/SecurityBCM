<div class="home-wrapper">
        ...
        <div class="card border border-success formcard">
                ...
                <form method="post" id="register-form" hidden>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="klantnummer" placeholder="Klantnummer"
                               name="klantnummer">
                        <small id="klantnummerhelp" class="form-text text-muted ml-1">Deze kunt u vinden op een van uw
                            facturen.</small>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="ml-1" for="wachtwoord">Wachtwoord</label>
                        <input type="password" class="form-control pr-password" id="wachtwoord" placeholder="Wachtwoord"
                               name="password">
