...
class Model
{
    ...
    {
        return [
            self::RULE_REQUIRED => 'Dit veld is verplicht',
            self::RULE_EMAIL => 'Ongeldig e-mailadres',
            self::RULE_MIN => 'Minimaal {min} karakters',
            self::RULE_MAX => 'Maximaal {max} karakters',
            self::RULE_MATCH => 'Dit veld moet hetzelfde zijn als {match}',
            self::RULE_UNIQUE => 'Al in gebruik',
        ];
    }
